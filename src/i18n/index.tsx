...
const BASE_DICT: Dict = {
  ...
  'followup.slot.who': { th: 'ใครกระทำ (บทบาท)', en: 'Who did it (role)', my: 'ဘယ်သူ (အခန်းကဏ္ဍ)', km: 'អ្នកណា (តួនាទី)', lo: 'ໃຜເຮັດ (ບົດບາດ)' },
  'followup.slot.harm': { th: 'ความเสียหาย', en: 'Harm / loss', my: 'ထိခိုက်မှု', km: 'ការខូចខាត', lo: 'ຄວາມເສຍຫາຍ' },
  'followup.slot.evidence': { th: 'หลักฐาน/พยาน', en: 'Evidence / witnesses', my: 'သက်သေ', km: 'ភស្តុតាង', lo: 'ຫຼັກຖານ' },
  'followup.slot.reported': { th: 'เคยแจ้งที่อื่นไหม', en: 'Reported elsewhere?', my: 'အခြားနေရာတိုင်ပြီးလား', km: 'បានរាយការណ៍កន្លែងផ្សេង?', lo: 'ເຄີຍແຈ້ງບ່ອນອື່ນບໍ' },
  'followup.slot.help': { th: 'ต้องการความช่วยเหลืออะไร', en: 'Help wanted', my: 'လိုချင်သောအကူအညီ', km: 'ជំនួយដែលចង់បាន', lo: 'ຕ້ອງການຄວາມຊ່ວຍເຫຼືອຫຍັງ' },
  ...
  'landing.rightsPreview.all': {
    ...
    my: 'အခွင့်အရေး ၁၅ ချက်လုံး ကြည့်ရန်', km: 'មើលសិទ្ធិទាំង ១៥', lo: 'ເບິ່ງສິດທັງ 15 ຂໍ້',
  },
  'landing.card2.title': {
  ...
  'landing.help.hl.social': {
    ...
    my: 'လူမှုဖူလုံရေး ဟော့လိုင်း', km: 'ខ្សែទូរស័ព្ទសុខុមាលភាពសង្គម', lo: 'ສາຍດ່ວນສະຫວັດດີການສັງຄົມ',
  },
  'landing.help.hl.labour': {
    th: 'สายด่วนแรงงาน', en: 'Labour hotline',
    my: 'အလုပ်သမား ဟော့လိုင်း', km: 'ខ្សែទូរស័ព្ទកម្មករ', lo: 'ສາຍດ່ວນແຮງງານ',
  },
  ...
  'report.about.title': {
    th: 'ขอรู้จักคุณสักนิดนะคะ', en: 'A little about you',
    my: 'သင့်အကြောင်း အကျဉ်းချုပ်', km: 'ស្តីអំពីអ្នកបន្តិច', lo: 'ກ່ຽວກັບຕົວທ່ານສັ້ນໆ',
  },
  'report.about.hint': {
  ...
  'report.about.gender.female': { th: 'หญิง', en: 'Female', my: 'မ', km: 'ស្រី', lo: 'ຍິງ' },
  'report.about.gender.diverse': { th: 'เพศหลากหลาย', en: 'Diverse gender', my: 'လိင်စဉ်စုံလင်မှု', km: 'ភេទចម្រុះ', lo: 'ເພດຫຼາກຫຼາຍ' },
  ...
  'report.needStory': {
    th: 'ช่วยเล่าให้เราฟังสักนิดนะคะ จะอัดเสียงหรือพิมพ์ก็ได้', en: 'Please record your voice or type your story',
  ...
  'report.area.title': {
    th: 'เรื่องนี้เกิดที่ไหนคะ', en: 'Where did it happen?',
    my: 'ဘယ်နေရာတွင် ဖြစ်ခဲ့သလဲ?', km: 'កើតឡើងនៅទីណា?', lo: 'ເກີດຂຶ້ນທີ່ໃດ?',
  },
  'report.area.hint': {
    th: 'บอกพื้นที่คร่าว ๆ ก็พอ จะช่วยให้เราแนะนำหน่วยงานใกล้คุณได้ ไม่สะดวกข้ามได้ค่ะ',
  ...
  'report.type.title': {
    th: 'เรื่องนี้เกี่ยวกับอะไรบ้างคะ เลือกได้มากกว่าหนึ่งข้อ', en: 'What is this about? (select any)',
    my: 'ဘာနှင့်ဆိုင်သနည်း? (အများကြီး ရွေးနိုင်သည်)', km: 'រឿងនេះទាក់ទងនឹងអ្វី? (ជ្រើសបានច្រើន)', lo: 'ເລື່ອງນີ້ກ່ຽວກັບຫຍັງ? (ເລືອກໄດ້ຫຼາຍຂໍ້)',
  },
  'report.type.body': {
    th: 'ความรุนแรงด้านร่างกาย', en: 'Physical violence',
    my: 'ရုပ်ပိုင်းဆိုင်ရာ အကြမ်းဖက်မှု', km: 'អំពើហិង្សារាងកាយ', lo: 'ຄວາມຮຸນແຮງທາງຮ່າງກາຍ',
  },
  'report.type.mental': {
    th: 'ความรุนแรงด้านจิตใจ', en: 'Mental / emotional violence',
    my: 'စိတ်ပိုင်းဆိုင်ရာ အကြမ်းဖက်မှု', km: 'អំពើហិង្សាផ្លូវចិត្ត', lo: 'ຄວາມຮຸນແຮງທາງຈິດໃຈ',
  },
  'report.type.labor': {
  ...
  'report.type.otherPh': {
    th: 'เล่าเพิ่มนิดนึงว่าเกี่ยวกับอะไร…', en: 'Tell us what it is about…',
    my: 'ဘာနှင့်ဆိုင်သည်ကို ပြောပါ…', km: 'ប្រាប់ថាវាទាក់ទងនឹងអ្វី…', lo: 'ເລົ່າເພີ່ມວ່າກ່ຽວກັບຫຍັງ…',
  },
  'report.contact.title': {
    th: 'ให้เราติดต่อกลับทางไหนดีคะ', en: 'How can we reach you?',
  ...
  'report.contact.phoneInvalid': {
    th: 'เบอร์นี้ดูไม่ถูกต้องค่ะ ลองเช็กอีกทีนะคะ ต้องมี 9 ถึง 15 หลัก', en: 'Please enter a valid phone number (9–15 digits)',
    my: 'မှန်ကန်သော ဖုန်းနံပါတ် ဖြည့်ပါ (၉–၁၅ လုံး)', km: 'សូមបញ្ចូលលេខទូរស័ព្ទត្រឹមត្រូវ (៩–១៥ ខ្ទង់)', lo: 'ກະລຸນາໃສ່ເບີໂທທີ່ຖືກຕ້ອງ (9–15 ຕົວເລກ)',
  },
  'report.submit': {
  ...
  'report.submitting': {
    th: 'กำลังส่งเรื่องให้นะคะ...', en: 'Submitting...', my: 'တင်သွင်းနေသည်...', km: 'កំពុងដាក់ស្នើ...', lo: 'ກຳລັງສົ່ງ...',
  },
  'report.success.title': {
    th: 'ได้รับเรื่องของคุณแล้วค่ะ', en: 'Report submitted',
  ...
  'report.success.saveImage': {
    ...
    my: 'ကုတ်ပုံ သိမ်းမည်', km: 'រក្សាទុករូបលេខកូដ', lo: 'ບັນທຶກຮູບລະຫັດເຄສ',
  },
  ...
  'report.train.consent': {
    ...
    my: 'ကျွန်ုပ်၏ မေးခွန်းနှင့် အဖြေများကို အမည်မဖော်ဘဲ SWING Rights ၏ AI ကို တိုးတက်စေရန်သာ အသုံးပြုခွင့်ပြုသည် (မဖြစ်မနေမဟုတ်)',
    km: 'អនុញ្ញាតឱ្យប្រើសំណួរ និងចម្លើយរបស់ខ្ញុំ ដោយមិនបញ្ចេញអត្តសញ្ញាណ ដើម្បីកែលម្អ AI របស់ SWING Rights តែប៉ុណ្ណោះ (ស្ម័គ្រចិត្ត)',
    lo: 'ຍິນຍອມໃຫ້ໃຊ້ຄຳຖາມ ແລະ ຄຳຕອບຂອງຂ້ອຍແບບບໍ່ລະບຸຕົວຕົນ ເພື່ອປັບປຸງ AI ຂອງ SWING Rights ເທົ່ານັ້ນ (ບໍ່ບັງຄັບ)',
  },
  'report.chat.agreed': {
  ...
  'report.chat.photos.ask': {
    th: 'มีรูปที่เกี่ยวกับเรื่องนี้ไหมคะ ถ้ามีแนบได้ไม่เกิน 3 รูป ไม่มีก็ข้ามได้ค่ะ', en: 'Any photos to attach? Up to 3 (optional).',
  ...
  'report.chat.input.placeholder': {
    th: 'พิมพ์ตรงนี้ หรือกดไมค์แล้วพูดได้เลย...', en: 'Type a message, or tap the mic to speak...',
  ...
  'report.probe.when.q': {
    th: 'เรื่องนี้เกิดขึ้นตอนไหนคะ แล้วเกิดบ่อยแค่ไหน',
  ...
  'report.probe.where.q': {
    th: 'เกิดขึ้นที่ไหนคะ เช่น ที่ทำงาน ที่พัก หรือในออนไลน์',
  ...
  'report.partners.title': {
    th: 'ต่อจากนี้ AI จะช่วยดูเรื่องของคุณตามพื้นที่และประเด็นก่อน แล้วเจ้าหน้าที่จะตรวจอีกที และโทรกลับไปเชื่อมคุณกับหน่วยงานที่เหมาะสมค่ะ',
    en: 'Next: ① AI analyzes your report by area and issues ② Staff review it, then call you back to connect you with the right organization',
    my: 'နောက်တစ်ဆင့်: ① AI က သင့်ဒေသနှင့် ပြဿနာအလိုက် ခွဲခြမ်းစိတ်ဖြာမည် ② ဝန်ထမ်းများ စစ်ဆေးပြီး သင့်တော်သော အဖွဲ့နှင့် ချိတ်ဆက်ရန် ပြန်ဖုန်းဆက်မည်',
    km: 'បន្ទាប់: ① AI វិភាគរឿងរបស់អ្នកតាមតំបន់ និងបញ្ហា ② បុគ្គលិកពិនិត្យ ហើយទូរស័ព្ទមកវិញ ដើម្បីភ្ជាប់អ្នកទៅអង្គភាពសមរម្យ',
    lo: 'ຂັ້ນຕໍ່ໄປ: ① AI ວິເຄາະເລື່ອງຂອງທ່ານຕາມພື້ນທີ່ ແລະ ປະເດັນ ② ເຈົ້າໜ້າທີ່ກວດສອບ ແລ້ວໂທກັບເພື່ອເຊື່ອມທ່ານກັບໜ່ວຍງານທີ່ເໝາະສົມ',
  },
  'report.partners.none': {
    th: 'เรื่องของคุณจะส่งถึงทีมกลางของมูลนิธิเพื่อนพนักงานบริการ แล้วทีมจะช่วยประสานหน่วยงานในพื้นที่ให้ค่ะ',
  ...
  'report.partners.ack': {
    th: 'รับทราบค่ะ ไปต่อ', en: 'Got it, continue',
  ...
  'report.success.forwardNone': {
    th: 'ทีมศูนย์กลางมูลนิธิเพื่อนพนักงานบริการ (จะประสานหน่วยงานในพื้นที่ให้)',
