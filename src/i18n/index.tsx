...
const BASE_DICT: Dict = {
  ...
  'followup.thinking': { th: 'AI กำลังตรวจว่ายังขาดข้อมูลอะไร…', en: 'AI is checking what is still missing…', my: 'AI စစ်ဆေးနေသည်…', km: 'AI កំពុងពិនិត្យ…', lo: 'AI ກຳລັງກວດ…' },
  ...
  'followup.complete': { th: 'ข้อมูลครบสำหรับแบบบันทึกแล้ว ขอบคุณ', en: 'All form details are covered — thank you', my: 'အချက်အလက်ပြည့်စုံပြီ', km: 'ព័ត៌មានគ្រប់គ្រាន់ហើយ', lo: 'ຂໍ້ມູນຄົບແລ້ວ' },
  ...
  'report.consent.body': {
    th: 'เราจะเก็บเสียงและข้อมูลที่คุณให้อย่างปลอดภัย ใช้เพื่อช่วยเหลือคุณเท่านั้น แยกเก็บข้อมูลระบุตัวตน และไม่เปิดเผยโดยไม่ได้รับอนุญาต — อ่านเพิ่มเติมในหน้านโยบายความเป็นส่วนตัว — หากต้องการรายงานเพื่อร้องทุกข์กล่าวโทษ จะต้องลงทะเบียนก่อน เพื่อใช้ข้อมูลดังกล่าวในการทำเอกสาร',
  ...
  'report.about.title': {
    th: 'แนะนำตัวสั้น ๆ', en: 'A little about you',
    my: 'သင့်အကြောင်း အကျဉ်းချုပ်', km: 'ស្តីអំពីអ្នកបន្តិច', lo: 'ກ່ຽວກັບຕົວທ່ານສັ້ນໆ',
  },
  'report.about.hint': {
    th: 'ใช้เพื่อเชื่อมต่อคุณกับความช่วยเหลือที่เหมาะสม — ไม่บังคับ ข้ามได้',
    en: 'Used to connect you with the right support — optional, you can skip.',
  ...
  'report.type.otherPh': {
    th: 'เล่าเพิ่มว่าเกี่ยวกับอะไร…', en: 'Tell us what it is about…',
  ...
  'report.contact.hint': {
    th: 'ต้องกรอกเบอร์โทรศัพท์จริง เพื่อให้เจ้าหน้าที่โทรกลับและช่วยประสานหน่วยงานให้คุณได้ — ถ้าไม่กรอกจะส่งเรื่องไม่ได้',
  ...
  'report.contact.confirmPhone': {
    th: 'ระบบกรอกเบอร์จากการลงทะเบียนให้แล้ว — ยืนยันว่าเบอร์นี้ติดต่อคุณได้ตอนนี้หรือไม่',
  ...
  'report.contact.phoneInvalid': {
    th: 'กรุณากรอกเบอร์โทรศัพท์ที่ถูกต้อง (9–15 หลัก)', en: 'Please enter a valid phone number (9–15 digits)',
  ...
  // ---------- Self report chat ----------
  'report.chat.greet': {
    th: 'สวัสดีค่ะ เราเป็นผู้ช่วยรับเรื่องของมูลนิธิเพื่อนพนักงานบริการ (SWING Foundation) จะถามทีละคำถามเหมือนคุยในแชต ตอบด้วยเสียงหรือพิมพ์ก็ได้ ไม่ต้องสมัครสมาชิก และทุกอย่างเป็นความลับ',
  ...
  'report.partners.title': {
    th: 'ขั้นต่อไป: ① AI จะวิเคราะห์เรื่องของคุณตามพื้นที่และประเด็น ② เจ้าหน้าที่จะตรวจสอบ แล้วโทรกลับเพื่อเชื่อมคุณกับหน่วยงานที่เหมาะสม',
  ...
  'report.partners.none': {
    th: 'เคสของคุณจะถูกส่งให้ทีมศูนย์กลางของมูลนิธิเพื่อนพนักงานบริการ ประสานหน่วยงานที่เหมาะสมในพื้นที่ของคุณต่อไป',
