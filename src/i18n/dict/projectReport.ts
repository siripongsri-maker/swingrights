...
export const PROJECT_REPORT_DICT: Record<string, Entry> = {
  ...
  'prep.byOccupation': { th: 'ตามอาชีพ', en: 'By occupation' },
  'prep.byNationality': { th: 'ตามสัญชาติ', en: 'By nationality' },
  'prep.byGender': { th: 'ตามเพศ', en: 'By gender' },
  'prep.byLanguage': { th: 'ตามภาษาที่รายงาน', en: 'By report language' },
  'prep.bySource': { th: 'ตามช่องทางรับเรื่อง', en: 'By intake channel' },
  'prep.byPartner': { th: 'การส่งต่อตามหน่วยงาน', en: 'Referrals by partner' },
