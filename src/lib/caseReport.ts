...
export const AI_DISCLAIMER =
  'ผลวิเคราะห์จาก AI เป็น "ความเห็นเบื้องต้นที่เจ้าหน้าที่ทบทวนแล้ว" ไม่ใช่คำวินิจฉัยทางการแพทย์หรือข้อสรุปทางกฎหมาย การประมวลผลด้วย AI กระทำภายในหน่วยงานเท่านั้น ข้อมูลจะไม่ถูกนำออกนอกหน่วยงาน ไม่ถูกนำไปฝึกสอนโมเดลภายนอก (เว้นแต่ผู้แจ้งยินยอมแยกให้ใช้แบบไม่ระบุตัวตนเพื่อปรับปรุง AI ของ SWING Rights เท่านั้น) และไม่ถูกใช้เพื่อการอื่นใดนอกเหนือจากวัตถุประสงค์ที่แจ้งไว้ตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 การตัดสินใจส่งต่อและดำเนินคดีอยู่บนดุลพินิจของเจ้าหน้าที่ผู้รับผิดชอบเคส';
